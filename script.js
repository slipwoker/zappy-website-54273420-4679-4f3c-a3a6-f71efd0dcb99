document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      const name = field.name || field.id || type;
  ...
  function initScrollAnimations() {
    const elements = document.querySelectorAll(OBSERVED_SELECTOR);
  ...
  (function applyRTLSupport() {
    ...
    if (isRTL) {
      ...
      styleEl.setAttribute('data-rtl-scroll', 'true');
      styleEl.textContent = [
        '.form-error-message { text-align: right; }',
        '.form-success-message { text-align: right; }'
      ].join('\n');
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '54273420-4679-4f3c-a3a6-f71efd0dcb99',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '54273420-4679-4f3c-a3a6-f71efd0dcb99';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '54273420-4679-4f3c-a3a6-f71efd0dcb99';
